...
use rust_shark_core::alert::Alert;
use rust_shark_core::inspector::InspectorApp;
use rust_shark_core::ipc::protocol::Event as IpcEvent;
use rust_shark_core::ipc::{IpcClient, Request, Response};
use rust_shark_core::store::models::ConnectionRow;
...
fn alert_line(a: &Alert) -> Line<'static> {
    let color = match a.severity {
        rust_shark_core::alert::Severity::Critical => Color::Red,
        rust_shark_core::alert::Severity::Warning => Color::LightRed,
        rust_shark_core::alert::Severity::Notice => Color::Yellow,
        rust_shark_core::alert::Severity::Info => Color::Gray,
    };
    Line::from(vec![
