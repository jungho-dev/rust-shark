...
/// Defaults shared by the CLI args and the no-subcommand default capture.
...
pub struct Cli {
    /// Subcommand to run. When omitted, rust-shark starts a live-capture TUI on
...
pub enum Command {
    ...
    Capture {
        ...
        #[arg(short, long, default_value_t = DEFAULT_SNAPLEN)]
        snaplen: i32,
